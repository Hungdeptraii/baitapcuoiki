...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (checkoutButton) {
        checkoutButton.addEventListener('click', () => {
            // Logic cho nút checkout
        });
    } else {
        console.error('checkout-button không tồn tại trong DOM.');
    }
...
document.addEventListener('DOMContentLoaded', function() {
    const creditCardsSection = document.getElementById('credit-cards');
    const paymentOptions = document.querySelectorAll('input[name="payment"]');

    paymentOptions.forEach(option => {
        option.addEventListener('change', function() {
            if (this.value === 'credit') {
                creditCardsSection.style.display = 'block';
            } else {
...
document.querySelectorAll('.credit-card-icons img').forEach(function(icon) {
            icon.addEventListener('click', function() {
                var cardType = this.getAttribute('data-card');
                
                // Ẩn tất cả các ô nhập thông tin thẻ
                document.querySelectorAll('.credit-card-details').forEach(function(detail) {
                    detail.style.display = 'none';
                });
                
                // Hiện ô nhập thông tin thẻ tương ứng với loại thẻ đã chọn
                document.getElementById(cardType + '-details').style.display = 'block';
            });
        });

        document.addEventListener('DOMContentLoaded', function() {
            var storedCardType = localStorage.getItem('selectedCard');
            if (storedCardType) {
                document.getElementById(storedCardType + '-details').style.display = 'block';
            ...
            document.querySelectorAll('.credit-card-icons img').forEach(function(icon) {
                icon.addEventListener('click', function() {
                    ...
                    // Lưu trạng thái lựa chọn thẻ vào local storage
                    localStorage.setItem('selectedCard', cardType + '-details');
                });
            });

            document.querySelector('input[name="payment"][value="credit"]').addEventListener('change', function() {
                if (this.checked) {
                    var storedCardType = localStorage.getItem('selectedCard');
                    if (storedCardType) {
                        document.getElementById(storedCardType).style.display = 'block';
                    }
                }
            });
        });